	...
	<div class="page" id="register-page">
      ...
      <div class="row">
            ...
            <div class="card-body">
              <div class="register-section" id="basic-details-section">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" name="signup_password" id="signup_password" value="" class="password-entry" <?php bp_form_field_attributes( 'password' ); ?>/>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" name="signup_password_confirm" id="signup_password_confirm" value="" class="password-entry-confirm" <?php bp_form_field_attributes( 'password' ); ?>/>
                </div>
        ...
        <div class="col-md-6 col-sm-12">
                    ...
                    <div<?php bp_field_css_class( 'editfield' ); ?>>
                      ...
                      if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
                        <p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>"><span id="<?php bp_the_profile_field_input_name(); ?>-2">
                          ...
                          <button type="button" class="visibility-toggle-link btn btn-primary" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-2" aria-expanded="false"><?php _ex( 'Change', 'Change profile field visibility level', 'buddypress' ); ?></button>
                        </p>
                        ...
                        <div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
                          ...
                          <button type="button" class="field-visibility-settings-close btn btn-primary"><?php _e( 'Close', 'buddypress' ) ?></button>
          ...
          <div class="submit">
            <input class="btn btn-primary btn-block" type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
          </div>
        </div>
      </div>
